...
class SeparatePathwayModel(nn.Module):
    """dHICA-inspired model with separate DNA and DNase pathways"""
    ...
    def __init__(self,
        ...
        print(f'Separate Pathway Model initialized')
...
class DeepHistoneEnformer:
    """Training wrapper for separate pathway model"""
    def __init__(self, 
                 use_gpu: bool = True,
    ...
    def _separate_inputs(self, seq_batch: np.ndarray, dns_batch: np.ndarray) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        #print(f"DEBUG: seq_batch shape: {seq_batch.shape}")
       # print(f"DEBUG: dns_batch shape: {dns_batch.shape}")
        ...
        #print(f"DEBUG: dna_tensor shape: {dna_tensor.shape}")
        #print(f"DEBUG: dnase_tensor shape: {dnase_tensor.shape}")
