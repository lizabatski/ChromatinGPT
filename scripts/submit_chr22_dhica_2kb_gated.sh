#!/bin/bash
#SBATCH --job-name=dual_pathway_c1024_l6_gated
#SBATCH --account=def-majewski
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=128G
#SBATCH --gres=gpu:1
#SBATCH --output=logs/dual_pathway_c1024_l6_gated_%j.out
#SBATCH --error=logs/dual_pathway_c1024_l6_gated_%j.err
...
echo "  Architecture: Dual-pathway (DNA + DNase) with gated fusion"
...
echo "Results saved to: results/E005_deephistone_2048bp_chr22_dual_pathway_c${C}_l${L}_h${H}_gated_*"