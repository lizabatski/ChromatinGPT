#!/bin/bash
#SBATCH --job-name=dual_pathway_heavy_chr22_take2
#SBATCH --account=def-majewski
#SBATCH --time=30:00:00  
#SBATCH --cpus-per-task=8
#SBATCH --mem=512G
#SBATCH --gres=gpu:1
#SBATCH --output=logs/dual_pathway_heavy_concat_chr22_take2_%j.out
#SBATCH --error=logs/dual_pathway_heavy_concat_chr22_take2_%j.err
